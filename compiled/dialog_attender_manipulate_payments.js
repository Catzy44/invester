...
export class DialogAttenderManupulatePayments extends React.Component {
  attenderId = -1;
  state = {
    payments: null,
    season: null,
  ...
  constructor(props) {
    ...
    gather(`uczestnicy/${this.attenderId}/closedMonths`, this, "closedMonths", errorF);
  ...
  render() {
    ...
    if (placeType == PlaceType.TYPE_ADULTS) {
      ...
      const startingMonth = parseInt(this.state.season['startDate'].split('-')[1]);
...
//# sourceMappingURL=dialog_attender_manipulate_payments.js.map